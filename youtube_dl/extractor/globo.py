...
class GloboIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        for resource in video['resources']:
            ...
            if not resource_url or (resource_type == 'media' and not resource_id) or resource_type not in (
            'subtitle', 'media'):
                continue
            ...
            resource_url, signed_hash, 'F' if video.get('subscriber_only') else 'A', security.get('user') or '')
