...
class AENetworksIE(AENetworksBaseIE):
    ...
    def _real_extract(self, url):
        ...
        if show_path:
            ...
            if url_parts_len == 1:
                entries = []
                for season_url_path in re.findall(r'(?s)<li[^>]+data-href="(/shows/%s/season-\d+)"' % url_parts[0],
                                                  webpage):
        ...
        if theplatform_metadata.get('AETN$isBehindWall'):
            ...
            resource = self._get_mvpd_resource(
                ...
                theplatform_metadata.get('AETN$PPL_pplProgramId') or theplatform_metadata.get(
                    'AETN$PPL_pplProgramId_OLD'),
