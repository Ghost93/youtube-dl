...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        if video_description:
            ...
            video_description = self._html_search_meta('description', video_webpage) or video_details.get(
                'shortDescription')
        ...
        if not formats and (video_info.get('license_info') or try_get(player_response,
